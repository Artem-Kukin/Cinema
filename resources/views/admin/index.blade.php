...
<form method="post" action="{{route('logout')}}">
  @csrf
  <div class="text-center"><a href="{{route('logout')}}" onclick="event.preventDefault(); this.closest('form').submit()"><button class="login__button">Выйти из учетной записи</button></a></div>
</form>
